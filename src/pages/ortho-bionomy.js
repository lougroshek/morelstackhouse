...
export default ({ location }) => {
  const pageMeta = {
    title: 'What is Ortho-Bionomy®?',
    type: 'ortho-bionomy',
    location: location,
    description: null,
    keywords: `ortho-bionomy, orthbionomy, bodywork, body work, massage, spine, back, gentle, healing, instruction, what is, about, morel, stackhouse`,
    image: null,
    url: `${location.href}`
  }
